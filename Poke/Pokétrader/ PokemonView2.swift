...
class PokemonView2: UICollectionViewController {
    var reuseIdentifier = "Cell2"
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vc : PostCriteria = storyboard.instantiateViewController(withIdentifier: "PostCriteria") as! PostCriteria
        vc.pokemonSelected2 = String(pokemonSelected)
